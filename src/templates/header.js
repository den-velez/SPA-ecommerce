const Header = (cart) => {
  ...
  <div class="header-menu">
    <a href="#/nuevosproductos"name="releases" class="header-menu-items"><span>New Releases</span></a>
    <a href="#/promociones"name="promotions" class="header-menu-items"><span>Promotions</span></a>
  </div>
